...
import { Close, Edit as EditIcon, LocalOffer } from "@mui/icons-material"
...
const Editproduit = ({ show, handleClose, pro, handleUpdateProduct }) => {
  ...
  useEffect(() => {
    if (pro && scategories.length > 0 && marques.length > 0) {
      ...
      const promoExists =
        pro.prixPromo !== undefined && pro.prixPromo !== null && pro.prixPromo > 0 && pro.prixPromo < pro.prix
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        <Typography variant="body2">Prix promotionnel</Typography>
                      </Box>
                    }
                  />
                </Box>
